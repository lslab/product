...
class Curl{
	...
	'autoRedirect'=>true,			//自动跳转 Location
	...
	public function post2($url,$params=array(),$uploadFile=array(), $referer=''){
		return $this->_request2('POST', $url, $params, $uploadFile, $referer);
	}
	...
	private function _request2($method, $url, $params=array(), $uploadFile=array(), $referer='')
	{
